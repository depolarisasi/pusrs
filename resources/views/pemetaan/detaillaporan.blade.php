...
<div class="my-3 my-md-5">
        ...
        <tbody>
            <tr>
                ...
                <tr>
                <td><b>Tanggal Pelayanan Pasien</b></td>
                
                <td>{{$detail->tanggal_pelaynan}}</td>
                </tr>
                <tr>
                ...
                Pemeriksaan Darah
                <br>Hemoglobin = {{$detail->hemoglobin}}
                
                <br>Leukosit = {{$detail->leukosit}}
                
                <br>Hematokrit = {{$detail->hematokrit}}%
